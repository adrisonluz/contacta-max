	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-secondary">
                ...
                <form id="formProduct" action="{{url('estoque/adicionar')}}" method="post" enctype="multipart/form-data">
                    <div class="panel-body">
                        ...
                        @else
                            ...
                            <div class="col-xs-12 text-center">
                                <a href="{{url('produtos/cadastrar')}}" class="btn btn-secondary" title="Adicionar Novo Produto" alt="Adicionar Novo Produto">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                <button type="submit" class="btn btn-secondary" title="Alterar estoque" alt="Alterar estoque">
                                Alterar estoque
                                </a>
                            </div>
                        </div>
